...
import kr.junhyung.mcagents.botfabric.tools.HoverSlotTool;
...
import kr.junhyung.mcagents.botfabric.tools.RunInputsTool;
...
public class BotFabricClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        tools.register(new RunInputsTool(scheduler));
        ...
        tools.register(new HoverSlotTool(scheduler));
