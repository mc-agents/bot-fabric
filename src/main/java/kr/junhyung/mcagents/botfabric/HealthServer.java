 ...
 *
 * <p>Liveness is the process. A bot waiting for an MCP server to come back is healthy and not
 * ready, and restarting it would throw away a Minecraft client that takes a minute to boot.
 */
